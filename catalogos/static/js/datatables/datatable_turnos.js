...
$(document).ready(function() {
    ...
    var table =$ ('#tabla_turnos').DataTable({
        ...
        columns: [
            ...
            // Inicializar timepicker en los campos de hora cuando el modal se muestra
    $('#turnoModal').on('shown.bs.modal', function () {
        ...
        $('#tabla_turnos tbody').on('click', '.btn-edit', function() {
            ...
            $('#estatus').val(data.estatus.toString());
            $('#turnoId').val(data.id);
            $('#turnoModal').modal('show');
        });
    ...
    // Inicializar el timepicker después de que el modal se muestre
    $('#turnoModal').on('shown.bs.modal', function () {
